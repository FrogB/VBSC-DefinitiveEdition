...
//'Blocked', 'Sweetcorn', 'Revise', 'Cob', 'Idiot', 'Apathetic', 'Screwed', 'Overthink', 'Nomophobia', 'Dismember', 'Kalampokiphobia', 'Reality-Breaking', 'Opposition', 'Cheating', 'Shit', 'Unfairness', 'Phonophobia', 'Hellbreaker'
	...
	override function create()
	{
		...
		controlsThingyPlaying.setFormat(Paths.font("comicsanslol.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		controlsThingyPlaying.scrollFactor.set();
		controlsThingyPlaying.alpha = 0;
		controlsThingyPlaying.borderSize = 2;

		controlsThingy = new FlxText(FlxG.width / 1.5, FlxG.height / 1.5, 400, "Press ENTER to play.\nPress UP or DOWN to scroll.\nPress BACK to exit the OST player.", 32);
		controlsThingy.setFormat(Paths.font("comicsanslol.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		songStats.setFormat(Paths.font("comicsanslol.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		songStats.scrollFactor.set();
		songStats.alpha = 0;
		songStats.borderSize = 2;

		pausedText = new FlxText(FlxG.width / 1.5, 200, 400, "PAUSED", 32);
		pausedText.setFormat(Paths.font("comicsanslol.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
