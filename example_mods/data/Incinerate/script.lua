...
function onUpdate()
  for i = 0,3 do
  setPropertyFromGroup('strumLineNotes',i,'alpha',0.5,3)
  end
...
function onBeatHit()
  ...
  if curBeat >= 96 then
    for i = 0,7 do
      noteTweenAngle('spinnywoah' .. i,i,getPropertyFromGroup('strumLineNotes',i,'angle')+240,crochet*0.008-0.01,'expoOut')
    end 
    if curBeat %1 == 0 then
