...
if name == "the camera tilt ANGER" then
...
doTweenAngle('bruhmomentoANGRY', 'camGame', 0, 0.5, 'cubeOut'); 
return
end
    if del > 0 then
		del = del - 1
	...
	if followchars == true then
       if mustHitSection == false then
	    ...
	    if getProperty('dad.animation.curAnim.name') == 'singRIGHT' then
                doTweenAngle('bruhmomentoANGRY', 'camGame', 15, 0.15, 'cubeOut');
                triggerEvent('Camera Follow Pos',xx+800+ofs,yy-100)
            end
            if getProperty('dad.animation.curAnim.name') == 'singUP' then
                doTweenAngle('bruhmomentoANGRY', 'camGame', -7.5, 0.15, 'cubeOut');
            ...
            if getProperty('boyfriend.animation.curAnim.name') == 'singLEFT' then
                doTweenAngle('bruhmomentoANGRY', 'camGame', -2.15, 0.15, 'cubeOut');
